        ...
        <div className="space-y-5 pb-28">
            ...
            {isLoading ? (
                ...
                <ProtectedBlurShell
                    ...
                    hint="Tap to unlock group list"
                    modalTitle="Unlock group list"
                    modalDescription={`Lab group lists for Section ${section} are protected. Enter your student details and the PIN from your Class Representative.`}
